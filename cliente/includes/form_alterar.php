    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nome" placeholder="digite seu nome" value="<?php echo $cliente["nome"]; ?>" required>
            </div>
        </div>
        <div class="col-xs-3">
            <div class="form-group">
                <label for="cpf">CPF</label>
                <input type="text" class="form-control" name="cpf" data-mask="999.999.999-99" placeholder="digite seu CPF" value="<?php echo $cliente["cpf"]; ?>" required>
            </div>
        </div>
         <div class="col-xs-3">
            <div class="form-group">
                <label for="email">E-mail</label>
                <input type="email" class="form-control" name="email" placeholder="digite seu email" value="<?php echo $cliente["email"]; ?>" required>
            </div>
        </div>
    </div>
    <div class="row">
